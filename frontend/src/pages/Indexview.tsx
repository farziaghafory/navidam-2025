                    ...
                    <div className="grid lg:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="flex flex-wrap gap-3 pt-2">
                                <a href="/personas" className="inline-flex items-center gap-2 px-4 py-3 rounded-2xl bg-slate-900 text-white hover:bg-slate-800 font-semibold transition">
                                    👥 Gestionar personas
                                </a>
                                <a href="/postal" className="inline-flex items-center gap-2 px-4 py-3 rounded-2xl bg-red-600 hover:bg-red-700 text-white font-extrabold transition">
                                    🚀 Crear postal
                                </a>
                            </div>
                            ...
                            <div className="grid sm:grid-cols-3 gap-3 pt-4">
                                {[
                                    { label: 'Plantillas', icon: '🎨', tech: 'HTML/Thymeleaf' },
                                    { label: 'Melodías', icon: '🎶', tech: 'MIDI' },
                                    { label: 'Orquestación', icon: '⚡', tech: 'n8n' },
                                ].map((item) => (
